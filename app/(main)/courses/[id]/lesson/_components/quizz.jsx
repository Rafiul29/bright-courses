...
const Quizz = ({ courseId, quizSet, isTaken }) => {
  ...
  const quizMarks = quizSet?.quizIds ? quizSet.quizIds.length * 5 : 0;
  console.log(quizSet, "quizMarks");
  return (
    <>
      <div className="max-w-[270px] bg-white border border-border rounded-md dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
        ...
        <div className="p-4">
          ...
          >
            ...
            <span>{isTaken ? `Quiz Taken` : `Participate a Quiz`}</span>
          </Button>
        </div>
      </div>
      <QuizModal
