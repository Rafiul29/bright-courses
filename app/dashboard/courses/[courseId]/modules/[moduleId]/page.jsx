...
import { getModuleDetails } from "@/queries/modules";
...
const Module = async ({ params: { courseId, moduleId } }) => {
  ...
  const lessons = replaceMongoIdInArray(moduleData?.lessonIds)?.sort(
    (a, b) => a?.order - b?.order
  );
        ...
        <div className="flex items-center justify-between">
          <div className="w-full">
            ...
            <div className="flex items-center justify-end">
              <ModuleActions courseId={courseId} module={moduleData} />
            </div>
          </div>
        </div>
